...
zones <- readRDS("../travelHack/data/PCT/msoa.Rds")
...
bus.stops <- st_read("../travelHack/data/osm/bus_stops_points.shp")
bike.parking <- st_read("../travelHack/data/osm/bike_parks_points.shp")
lines <- readRDS("../travelhack/data/listofroutes.Rds")
